...
flowchart TB
    ...
    subgraph ParserAdapters ["Parser Language Adapters"]
        ...
        LangAdapters["Regex Adapters, inline and src/languages/ (78 non-tree-sitter languages)<br/><small>C#, PHP, Kotlin, GraphQL, SQL, Proto, Apex, Nginx, Caddyfile, Apache, etc.</small>"]:::adapter
    end
