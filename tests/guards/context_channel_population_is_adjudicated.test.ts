...
const ADJUDICATED: Readonly<Record<string, string>> = {
  ...
  'hooks_bash.ts::maybeEmitLargeUncompressedHint':
    'Interpolates the shell command escaped through displaySafeText, a calculated KB integer, and the hexadecimal cached output ID generated by storeBashOutput.',
