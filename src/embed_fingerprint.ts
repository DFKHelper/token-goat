...
export const EMBED_FINGERPRINT = '514d245a9048e9bc'
...
export const EMBED_KIND_FINGERPRINTS: ReadonlyMap<string, string> = new Map([
  ['docx', '2df392f7603aeced'],
  ['markdown', '8a4625388388253b'],
  ['pdf', '8e6ecc8ad482fee6'],
  ['pptx', 'e1807ebc4e9e413f'],
  ['xlsx', 'b53afd22dd469dd4'],
])
