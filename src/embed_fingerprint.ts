...
export const EMBED_FINGERPRINT = '2310db32d9bc8a2b'
...
export const EMBED_KIND_FINGERPRINTS: ReadonlyMap<string, string> = new Map([
  ['docx', '7365875b7c4a3679'],
  ['markdown', 'a801a87da1885b59'],
  ['pdf', 'df1504a2217ff390'],
  ['pptx', 'f4482298cb79dd34'],
  ['xlsx', '8050058c6400e2a5'],
])
