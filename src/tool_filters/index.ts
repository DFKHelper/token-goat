...
export { makeNodeTestRunnerFilter, makePackageManagerFilter, plural } from './families.js'
export type { NodeTestRunnerConfig, PackageManagerFilterConfig, DropRule } from './families.js'
