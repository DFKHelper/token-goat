...
CLAUDE_MD_CONTENT = (
    ...
    "- `token-goat skill-compact <name>` — alias for skill-body --compact\n"
    "- `token-goat skill-size [--session-id <id>]` — show token counts for all cached skills\n"
    "- `token-goat skill-list [--session-id <id>]` — list loaded skills and compact availability\n"
