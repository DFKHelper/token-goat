...
HOOK_EVENTS: tuple[HookEvent, ...] = (
    ...
    HookEvent(
        ...
        attr="pre_fetch",
        claude_event="PreToolUse",
        claude_matcher="mcp__claude_ai_Google_Drive__.*|WebFetch",
        claude_timeout_ms=2000,
        codex_event="PreToolUse",
        codex_matcher="mcp__claude_ai_Google_Drive__.*|web_search",
    ...
    HookEvent(
        ...
        attr="pre_screenshot",
        claude_event="PreToolUse",
        claude_matcher=r"mcp__.*take_screenshot|mcp__.*browser_take_screenshot",
        claude_timeout_ms=2000,
        codex_event=None,
        codex_matcher="",
        codex_timeout_ms=0,
